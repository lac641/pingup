        ...
        <div className="bg-white rounded-lg shadow p-6 w-full">
          ...
          <form className="space-y-4" onSubmit={handleSaveProfile}>
            ...
            <div>
              ...
              <input type="text" className="w-full p-3 border border-gray-800 rounded-lg outline-none" placeholder="Please enter your full name" onChange={(e) => setEditForm({ ...editForm, location: e.target.value })} value={editForm.location} />
