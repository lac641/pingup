...
const StoryModel = ({ setShowModal, fetchStories }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-[110] min-h-screen bg-black/80 backdrop-blur flex items-center justify-center p-4"
      onClick={() => setShowModal(false)}
    >
      {/* Modal Content */}
      <div
        className="w-full max-w-md text-white bg-transparent transform transition-all duration-300 scale-95 opacity-0 animate-fadeIn"
