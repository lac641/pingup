    ...
    images.length > 0 && <div className='flex flex-wrap gap-2 mt-4'>
      {images.map((image, i)=>(
        <div key={i} className='relative group w-20 h-20'>
          ...
          <div onClick={()=> setImages(images.filter((_, index)=> index !== i))} className='absolute top-1 right-1 bg-black/60 p-1 rounded-full cursor-pointer hidden group-hover:block'>
